...
const generateItemElement = function (item) {
  ...
  if (item.edit) {
    ...
    <label for="edit-item-entry">Edit item:</label>
    <input type="text" name="edit-item-entry" class="js-edit-entry" value="${item.name}">
    <button type="submit">Add item</button>
    </form>
      <div class='shopping-item-controls'>
        <button class='shopping-item-toggle js-dummy-button'>
          <span class='button-label'>check</span>
        </button>
        <button class='shopping-item-delete js-dummy-button'>
          <span class='button-label'>delete</span>
        </button>
        <button class='edit-item js-dummy-button'>
    ...
    <li class='js-item-element' data-item-id='${item.id}'>
      <span class='js-item-name'>${itemTitle}</span>
      <div class='shopping-item-controls'>
...
function handleEditItemClick() {
  $('.js-shopping-list').on('click', '.js-edit-item', (evt) => {
...
function handleDoneEditingItemClick() {
  $('.js-shopping-list').on('submit', '#js-name-edit-form', function (event) {
    event.preventDefault();
    const id = getItemIdFromElement(event.currentTarget);
    const newName = $('.js-edit-entry').val();
...
function handleDummyButtons() {
  $('.js-dummy-button').on('click', (evt) => evt.preventDefault);
}
